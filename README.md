...
本仓库整理了本人在中国大学生机械工程创新创意大赛中的部分核心代码与数据分析任务，内容涵盖工业监测数据读取、统计特征分析、异常检测与维护需求预测等环节。仓库在保留原始题目逻辑与比赛环境约束的基础上，对代码结构、命名方式、目录组织与运行流程进行了系统整理，用于展示本人在**数据理解、任务实现、工程组织与赛后重构**方面的综合能力。
